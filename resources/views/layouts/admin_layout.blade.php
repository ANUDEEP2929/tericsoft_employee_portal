                    ...
                    <div
                        ...
                        <ul class="m-menu__nav  m-menu__nav--dropdown-submenu-arrow ">
                            ...
                            <li class="m-menu__item  m-menu__item--submenu" aria-haspopup="true">
                                <a  href="admin/admin_home" class="m-menu__link m-menu__toggle">
                                        <span class="m-menu__link-text">
                                            Employees
                                        </span>
                            ...
                            <li class="m-menu__item  m-menu__item--submenu" aria-haspopup="true">
                                <a  href="admin/sendDocuments" class="m-menu__link m-menu__toggle">
                                        <span class="m-menu__link-text">
                                            Send Documents
                                        </span>
                                    <!-- <i class="m-menu__ver-arrow la la-angle-right"></i> -->
                            ...
                            <li class="m-menu__item  m-menu__item--submenu">
                                <a  href="admin/sendNotifications" class="m-menu__link m-menu__toggle">
                                        <span class="m-menu__link-text">
                                            Send Notifications
                                        </span>
                                    <!-- <i class="m-menu__ver-arrow la la-angle-right"></i> -->
                            ...
                            <li class="m-menu__item  m-menu__item--submenu">
                                <a  href="admin/documentsList" class="m-menu__link m-menu__toggle">
                                        <span class="m-menu__link-text">
                                            Documents List
                                        </span>
                                    <!-- <i class="m-menu__ver-arrow la la-angle-right"></i> -->
                            ...
                            <li class="m-menu__item  m-menu__item--submenu">
                                <a  href="admin/contact_info" class="m-menu__link m-menu__toggle">
                                        <span class="m-menu__link-text">
                                            Contact Info
                                        </span>
                                    <!-- <i class="m-menu__ver-arrow la la-angle-right"></i> -->
